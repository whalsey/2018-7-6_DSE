...
logging.debug("READING IN 2017 TARGETS...")
targets = pd.read_csv("../Input/train_2017.csv")
...
combined.to_csv("../Input/combined_2017.csv", sep=',', encoding='utf-8')
# combined.drop(['DATE'])
